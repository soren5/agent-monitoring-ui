...
export const GITHUB_APP_ID = process.env.GITHUB_APP_ID || envConfig.GITHUB_APP_ID || '';
export const GITHUB_APP_INSTALLATION_ID =
  process.env.GITHUB_APP_INSTALLATION_ID || envConfig.GITHUB_APP_INSTALLATION_ID || '';
export const GITHUB_APP_PRIVATE_KEY_PATH =
  process.env.GITHUB_APP_PRIVATE_KEY_PATH || envConfig.GITHUB_APP_PRIVATE_KEY_PATH || '';
