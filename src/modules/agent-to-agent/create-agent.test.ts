...
describe('create_agent — retired raw creation path', () => {
  it.each(['global', 'group', 'disabled'])('denies direct creation for %s scope', async (cli_scope) => {
  ...
  it('does not let even a valid old approval replay bypass the provisioning contract', async () => {
